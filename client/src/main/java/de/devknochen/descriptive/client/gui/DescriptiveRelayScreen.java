...
public class DescriptiveRelayScreen extends Screen {
    ...
    private static final ContentLine[] BENEFITS = {
            new ContentLine("✔", 0xFF55FF55, "Custom names work on any server, vanilla or modded."),
    ...
    private static final ContentLine[] WARNINGS = {
            ...
            new ContentLine(null, 0,         "address are transmitted to a external websocket server"),
