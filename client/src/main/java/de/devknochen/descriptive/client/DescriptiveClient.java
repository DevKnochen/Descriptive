...
import de.devknochen.descriptive.client.command.DescriptiveCommand;
...
public class DescriptiveClient implements ClientModInitializer {
    ...
    public DescriptiveConfig getConfig() {
        return config;
    }
}