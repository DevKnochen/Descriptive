...
public record DescriptivePayload(
    ...
    public byte[] encode() {
        try {
            ...
            // version 1: coloring & formatting data
    ...
    private static void writeVarInt(java.io.DataOutputStream out, int value)
    ...
    private static int readVarInt(java.io.DataInputStream in)
            throws java.io.IOException {
    ...
    private static void writeUuid(java.io.DataOutputStream out, UUID uuid)
            throws java.io.IOException {
        out.writeLong(uuid.getMostSignificantBits());
        out.writeLong(uuid.getLeastSignificantBits());
    }

    private static UUID readUuid(java.io.DataInputStream in)
            throws java.io.IOException {
    ...
    private static void writeString(java.io.DataOutputStream out, String s)
            throws java.io.IOException {
    ...
    private static String readString(java.io.DataInputStream in)
            throws java.io.IOException {
